...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.hidden'
        db.add_column(u'website_video', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.hidden'
        db.delete_column(u'website_video', 'hidden')
    ...
    models = {
        u'website.blog': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 28, 0, 0)'}),
